...
namespace Tiui.Data
{
  ...
  public class TiuiDBContext : DbContext
  {
    ...
    public TiuiDBContext(DbContextOptions<TiuiDBContext> optionsBuilder) : base(optionsBuilder)
    {
    }
    #endregion
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
      if (!optionsBuilder.IsConfigured)
      {
        ...
        optionsBuilder.UseNpgsql("Host=tiui-prod.cluster-cp0tdihlsymi.us-east-1.rds.amazonaws.com;Database=TiuiDB;Username=postgres;Password=Asdf1234$;");
      }
    }
