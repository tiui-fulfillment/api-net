...
{
  /// <summary>
  /// Implementación del estatus GuiaConsolidadoEnCedisCDMXState
  /// </summary>
  public class GuiaFulfillmentEnCedisCDMXState : BaseState
  {
    public GuiaFulfillmentEnCedisCDMXState(IBaseStateContext context)
    {
      if (context is Guia)
    ...
    {
      return (int)EEstatusGuia.FULFILLMENT_EN_CEDIS_CDMX;
    }

    public override string GetName()
    {
      return "Tu envío está en CEDIS Tiui CDMX";
    }
    /// <summary>
