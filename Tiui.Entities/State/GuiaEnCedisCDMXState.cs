...
{
  /// <summary>
  /// Implementación del estatus GuiaEnCedisCDMXState
  /// </summary>
  public class GuiaEnCedisCDMXState : BaseState
  {
    public GuiaEnCedisCDMXState(IBaseStateContext context)
    {
      if (context is Guia)
    ...
    {
      return (int)EEstatusGuia.EN_CEDIS_CDMX;
    }
