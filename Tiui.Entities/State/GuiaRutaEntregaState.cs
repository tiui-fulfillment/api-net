...
{
  /// <summary>
  /// Implementación del state GuiaRutaEntregaState
  /// </summary>
  public class GuiaRutaEntregaState : BaseState
  {
    public GuiaRutaEntregaState(IBaseStateContext context)
    {
      if (context is Guia)
    ...
    {
      return (int)EEstatusGuia.RUTA_ENTREGA;
    }
    /// <summary>
    ...
    {
      return "Tu envío está en ruta de entrega";
    }
    /// <summary>
