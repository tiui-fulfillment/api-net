...
namespace Tiui.Entities.State
{
    ...
    public class GuiaCanceladoState : BaseState, ICancelState
    {
        ...
        public override void Handle()
        {
            ...
            if (guia.Estatus.Proceso.ToUpper().Equals(ETipoProceso.CELEBRANDO.GetString()) || (guia.Estatus.Proceso.ToUpper().Equals(ETipoProceso.PREPARANDO.GetString()) && this._motivoCancelacion.TipoCancelacion != ETipoCancelacion.ANTES_DE_RUTA)
